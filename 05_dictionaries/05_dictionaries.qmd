...
- There are two fundamental approaches to the lexicon.
    - The first is that, in the slogan, the lexicon is **the home of the lawless** [@DiSciullo1987Definition]: that is, the lexicon contains whatever cannot be predicted by general rule.
